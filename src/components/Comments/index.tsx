...
function Comments() {
    return (
        <div className="flex mx-4 mt-12 flex-col gap-6 pt-20 relative md:mx-[100px]">
            <div className="flex">
                <p className="text-[32px] font-bold leading-9">OUR HAPPY CUSTOMERS</p>
            </div>
                        ...
                        >
                            <div className="border border-black border-opacity-10 rounded-3xl px-6 py-6 md:px-8 md:py-7">
                                ...
                                <span className="flex md:mt-4 md:mb-4">
                                    <p className="capitalize text-base font-bold">Sarah M.</p>
                                    <FontAwesomeIcon
                                        icon={faCircleCheck}
                                ...
                                <p>
                                    ...
                                    From casual wear to elegant dresses, every piece I've bought has exceeded my
                                    expectations.”
                                </p>
                            </div>
                        </SwiperSlide>
